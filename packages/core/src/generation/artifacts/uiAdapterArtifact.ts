export type UiAdapterTarget = 'fallback' | 'archora-ui' | 'vanilla-ts' | 'custom'

export function createUiAdapter(ui: UiAdapterTarget): string {
  if (ui === 'archora-ui') {
    return `export {\n  ArchBadge,\n  ArchButton,\n  ArchDataTable,\n  ArchDatePicker,\n  ArchInput,\n  ArchSelect,\n  ArchSwitch,\n  ArchTextarea,\n} from '@archora/ui'\n`
  }

  return createArchoraUiFallback()
}

function createArchoraUiFallback(): string {
