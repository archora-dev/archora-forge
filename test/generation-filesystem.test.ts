...
describe('framework-agnostic resource contract generation', () => {
  ...
  test('summarizes missing and mismatched generated metadata', async () => {
    ...
    expect(summary.version).toBe('1.2.1')
    ...
    expect(summary.files.versionMismatches).toEqual([{ path: 'src/shared/api/generated/users/users.client.ts', expected: '1.2.1', actual: '0.9.0' }])
